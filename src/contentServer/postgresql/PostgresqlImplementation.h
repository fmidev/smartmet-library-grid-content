...
class PostgresqlImplementation : public ServiceInterface
{
  public:
   ...
   protected:
     ...
     int            deleteProducerById(uint producerId,bool deleteGenerations,bool deleteGenerationGeometries,bool deleteFiles,bool deleteContent);
     int            deleteProducerListBySourceId(uint sourceId,bool deleteGenerations,bool deleteGenerationGeometries,bool deleteFiles,bool deleteContent);
     ...
     int            deleteGenerationById(uint generationId,bool deleteGenerationGeometries,bool deleteFiles,bool deleteContent);
     int            deleteGenerationListByProducerId(uint producerId,bool deleteGenerationGeometries,bool deleteFiles,bool deleteContent);
     int            deleteGenerationListBySourceId(uint sourceId,bool deleteGenerationGeometries,bool deleteFiles,bool deleteContent);
     ...
     int            getContentByGenerationIdAndTimeRange(uint generationId,const std::string& startTime,const std::string& endTime,T::ContentInfoList& contentInfoList);
