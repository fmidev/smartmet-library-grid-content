...
class ServerInterface : public POA_SmartMet::ContentServer::Corba::ServiceInterface
{
  public:
    ...
    ::CORBA::Long getGenerationInfoListByGeometryId(::CORBA::LongLong sessionId, ::CORBA::ULong geometryId, SmartMet::ContentServer::Corba::CorbaGenerationInfoList_out generationInfoList);
    ...
    ::CORBA::Long deleteFileInfoListByGenerationIdAndForecastTime(::CORBA::LongLong sessionId, ::CORBA::ULong generationId, ::CORBA::ULong geometryId, ::CORBA::Short forecastType, ::CORBA::Short forecastNumber, const char* forecastTime);
