...
class ServerInterface : public POA_SmartMet::ContentServer::Corba::ServiceInterface
{
  public:
    ...
    ::CORBA::Long getContentListByRequestCounterKey(::CORBA::LongLong sessionId, ::CORBA::ULongLong key, SmartMet::ContentServer::Corba::CorbaContentInfoList_out contentInfoList);
