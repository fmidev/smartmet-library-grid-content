...
::CORBA::Long ServerInterface::getContentListByRequestCounterKey(::CORBA::LongLong sessionId, ::CORBA::ULongLong key, SmartMet::ContentServer::Corba::CorbaContentInfoList_out contentInfoList)
{
  FUNCTION_TRACE
  try
  {
