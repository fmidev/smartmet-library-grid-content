...
class RedisImplementation : public ServiceInterface
{
  public:
     ...
     virtual void   lock(const char *function,uint line,UInt64 & key,uint waitTimeInSec,bool resetLock);
     virtual void   unlock(UInt64 key);
   ...
   protected:
     ...
     int            deleteProducerById(T::ProducerId producerId,bool deleteGenerations,bool deleteGeometries,bool deleteFiles,bool deleteContent);
     int            deleteProducerListBySourceId(T::SourceId sourceId,bool deleteGenerations,bool deleteGeometries,bool deleteFiles,bool deleteContent);
     ...
     int            deleteGenerationById(T::GenerationId generationId,bool deleteGeometries,bool deleteFiles,bool deleteContent);
     int            deleteGenerationListByProducerId(T::ProducerId producerId,bool deleteGeometries,bool deleteFiles,bool deleteContent);
     int            deleteGenerationListBySourceId(T::SourceId sourceId,bool deleteGeometries,bool deleteFiles,bool deleteContent);
     ...
     int            deleteGeometryById(T::GenerationId generationId,T::GeometryId geometryId,T::ParamLevelId levelId,bool deleteFiles,bool deleteContent);
     int            deleteGeometryListByGenerationId(T::GenerationId generationId,bool deleteFiles,bool deleteContent);
     int            deleteGeometryListByProducerId(T::ProducerId producerId,bool deleteFiles,bool deleteContent);
     int            deleteGeometryListBySourceId(T::SourceId sourceId,bool deleteFiles,bool deleteContent);
     int            getGeometryById(T::GenerationId generationId,T::GeometryId geometryId,T::ParamLevelId levelId,T::GeometryInfo& geometryInfo);
     int            getGeometryList(T::GeometryInfoList& geometryInfoList);
     int            getGeometryListByProducerId(T::ProducerId producerId,T::GeometryInfoList& geometryInfoList);
     int            getGeometryListByGenerationId(T::GenerationId generationId,T::GeometryInfoList& geometryInfoList);
     int            getGeometryListByGenerationIdList(std::set<T::GenerationId>& generationIdList,T::GeometryInfoList& geometryInfoList);
     int            getGeometryListBySourceId(T::SourceId sourceId,T::GeometryInfoList& geometryInfoList);
     int            deleteGeometryListByGenerationIdList(std::set<T::GenerationId>& generationIdList,bool deleteFiles,bool deleteContent);
     ...
     int            deleteContentByGeometry(T::GenerationId generationId,T::GeometryId geometryId,T::ParamLevelId levelId);
     ...
     int            addFilename(std::string filename,T::FileId fileId);
     int            deleteFilename(std::string filename);
     T::FileId      getFileId(std::string filename);
