...
class ContentInfoList
{
  public:
    ...
    void                getContentInfoListByGenerationId(uint producerId,uint generationId,const std::string& forecastTime,const std::string& endTime,ContentInfoList& contentInfoList);
