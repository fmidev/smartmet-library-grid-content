...
// ====================================================================================
/*! \brief Tests whether each grid value is greater than a threshold, returning 1 or 0. */
// ====================================================================================

class Function_gt : public Function
{
  public:
                      Function_gt();
                      Function_gt(const Function_gt& function);
    virtual           ~Function_gt();
