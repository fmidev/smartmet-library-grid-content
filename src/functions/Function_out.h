...
// ====================================================================================
/*! \brief Tests whether each grid value falls outside a specified [min, max] range, returning 1 or 0. */
// ====================================================================================

class Function_out : public Function
{
  public:
                      Function_out();
                      Function_out(const Function_out& function);
    virtual           ~Function_out();
