...
void PointValueCache::addValue(uint fileId,uint messageIndex,T::CoordinateType coordinateType,double x,double y,T::InterpolationMethod interpolationMethod,T::ParamValue value)
{
  try
  {
    uint maxAge = 300;
...
bool PointValueCache::getValue(uint fileId,uint messageIndex,T::CoordinateType coordinateType,double x,double y,T::InterpolationMethod interpolationMethod,T::ParamValue& value)
{
  try
  {
    std::size_t key = getKey(fileId,messageIndex,coordinateType,x,y,interpolationMethod);
...
void PointValueCache::deleteValue(uint fileId,uint messageIndex,T::CoordinateType coordinateType,double x,double y,T::InterpolationMethod interpolationMethod)
{
  try
  {
    std::size_t key = getKey(fileId,messageIndex,coordinateType,x,y,interpolationMethod);
...
std::size_t PointValueCache::getKey(uint fileId,uint messageIndex,T::CoordinateType coordinateType,double x,double y,T::InterpolationMethod interpolationMethod)
{
  try
  {
    char buf[100];
    sprintf(buf,"%08x%04x%u%f%f%u",fileId,messageIndex,(uint)coordinateType,x,y,(uint)interpolationMethod);
