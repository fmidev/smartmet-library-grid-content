...
class ServerInterface : public POA_SmartMet::DataServer::Corba::ServiceInterface
{
  public:
    ...
    ::CORBA::Long getGridValueVectorByTime(::CORBA::LongLong sessionId, ::CORBA::ULong fileId1, ::CORBA::ULong messageIndex1, ::CORBA::ULong fileId2, ::CORBA::ULong messageIndex2, const char* newTime, ::CORBA::ULong flags, SmartMet::DataServer::Corba::CorbaParamValueList_out values);
