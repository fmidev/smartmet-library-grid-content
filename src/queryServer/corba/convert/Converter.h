...
class Converter
{
  public:
    ...
    static void   convert(std::set<int>& source,QueryServer::Corba::CorbaLongList& target);
    static void   convert(const QueryServer::Corba::CorbaLongList& source,std::set<int>& target);

    static void   convert(std::set<time_t>& source,QueryServer::Corba::CorbaULongLongList& target);
    static void   convert(const QueryServer::Corba::CorbaULongLongList& source,std::set<time_t>& target);
